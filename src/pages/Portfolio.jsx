...
function Portfolio() {
    return(
        ...
        <Heading as="h1" mt="50px">Portfolio</Heading><br/>
            <Heading as="h2" fontSize="24px">Umbrella Weather App</Heading>
            <Text>
            ...
            <Heading as="h2" fontSize="24px">The Programmer's Guide to the Galaxy</Heading>
            <Text>
            ...
            <Heading as="h2" fontSize="24px">Social Network API</Heading>
            <Text>
